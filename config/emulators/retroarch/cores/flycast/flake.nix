{
  description = "Semu build of libretro core flycast 0-unstable-d8a76809e5 from its pinned upstream source";

  inputs = {
    nixpkgs.url = "github:NixOS/nixpkgs/e554fab72f81915600f3f449b786fd9af40439a5";
    source = { url = "git+https://github.com/flyinghead/flycast?rev=d8a76809e57027da36d88bafb670983541de5ba1&submodules=1"; flake = false; };
  };
  ...
  outputs = { self, nixpkgs, source }:
    let
      ...
      build = system:
        ...
        pkgs.libretro.flycast.overrideAttrs (previous: {
          version = "0-unstable-d8a76809e5";
          src = source;
    ...
    in {
      semu = {
        ...
        version = "0-unstable-d8a76809e5";
        inherit platforms;
        source = { url = "git+https://github.com/flyinghead/flycast?rev=d8a76809e57027da36d88bafb670983541de5ba1&submodules=1"; rev = source.rev; narHash = source.narHash; };
      };

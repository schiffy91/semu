...
def test_syncthing_validates_device_id_format():
    assert syncthing._valid_device_id("AAAAAAA-BBBBBBB-CCCCCCC-DDDDDDD-EEEEEEE-FFFFFFF-GGGGGGG-HHHHHHH")
    assert not syncthing._valid_device_id("too-short")
    assert not syncthing._valid_device_id("")
    assert not syncthing._valid_device_id("ABC-DEF-GHI-JKL-MNO-PQR-STU-VWX")  # chunks too short

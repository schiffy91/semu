...
# semu_tap.h (see packaging/steamdeck/tap/). No pixel hacks. Cross-built for the Steam Deck
...
#
# NOTE: the patch (packaging/steamdeck/tap/retroarch-semu-tap.patch) is authored against the

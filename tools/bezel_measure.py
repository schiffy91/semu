# Screen-opening measurement for bezel packages: finds display openings in a plate (dark or
# transparent regions, opaque glass lenses, seeded uniform regions, outlined panels by raycast) and
# reports their rectangles, corner radii and fill in plate pixels. Imported by bezel-measure.py
# (the CLI) and bezel_dimensions.py (the package writer).
